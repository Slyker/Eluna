...
namespace LuaGlobalFunctions
{
    ...
    */
    ...
    ElunaRegister<> GlobalMethods[] =
    {
        ...
        { "WorldDBQueryAsync", &LuaGlobalFunctions::WorldDBQueryAsync, METHOD_REG_ALL, METHOD_FLAG_UNSAFE },
        ...
        { "CharDBQueryAsync", &LuaGlobalFunctions::CharDBQueryAsync, METHOD_REG_ALL, METHOD_FLAG_UNSAFE },
        ...
        { "AuthDBQueryAsync", &LuaGlobalFunctions::AuthDBQueryAsync, METHOD_REG_ALL, METHOD_FLAG_UNSAFE },
